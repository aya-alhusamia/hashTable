...
let leng = prompt("Enter the max num in class: ")
let studentTable = new HashTable(leng)
 students.forEach((student)=>{
    studentTable.insert(student.name,student.score)
 })
 console.log(studentTable.classes)
